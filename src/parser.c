...
enum {
  ...
  sym__color_value = 53,
  sym__string = 54,
  aux_sym__token_body = 55,
  sym_a98rgb = 56,
  sym_asterisk = 57,
  sym_child_token_block = 58,
  ...
  aux_sym__color_value_repeat1 = 81,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__color_value, 2),
  [108] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__color_value_repeat1, 2),
  [110] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__color_value_repeat1, 2), SHIFT_REPEAT(249),
  ...
  [283] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__color_value_repeat1, 2), SHIFT_REPEAT(172),
